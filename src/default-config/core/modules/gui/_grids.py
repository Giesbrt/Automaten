...
from ._graphic_items import TransitionFunction, TokenListFrame, TokenButton, StateGraphicsItem, StateConnectionGraphicsItem, LabelGraphicsItem
    ...
    def get_active_state(self, active_state) -> StateItem | None:
        ...
        for item in self.scene().items():
            if isinstance(item, StateItem):
                ...
                print(item.get_ui_state(), active_state)
