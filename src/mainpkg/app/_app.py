...
# dancer
from dancer import Translator, config  # , Translation
...
class App(DefaultAppGUIQt):
    ...
    def update_title(self) -> None:
        ...
        formatted_title: str = raw_title.safe_substitute(program_name=config.PROGRAM_NAME,
                                                         version=config.VERSION,
                                                         version_add=config.VERSION_ADD,
